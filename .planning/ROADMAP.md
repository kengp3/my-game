...
### Phase 03.1: 圖片搜集與整合 — 從網路搜集角色、裝備、Boss 等頁面所需圖片，補上所有 image: null 的佔位內容 (INSERTED)
...
Plans:
- [ ] 03.1-01-PLAN.md — Wave 0 infra: sharp devDep, scripts/convert-images.cjs, scripts/verify-images.mjs, public/images/ tree
- [ ] 03.1-02-PLAN.md — Wave 1 download 8 PNGs from Fextralife + convert to WebP via sharp (depends on 01)
- [ ] 03.1-03-PLAN.md — Wave 2 update 8 Markdown frontmatter image: null -> /images/{cat}/{slug}.webp (depends on 02)
- [ ] 03.1-04-PLAN.md — Wave 2 fix withBase() :src binding in 3 Vue templates (depends on 01, parallel with 03)
